...
const Footer = () => {
    return (
        <footer style={{ backgroundImage: `url(${footer})`, backgroundSize: 'contain' }} className=" px-10 pt-10 ">
            <div className='footer'>
                ...
                <nav>
                    ...
                    <a className="link link-hover text-accent">Teeth Whitening</a>
                </nav>
                <nav>
                    <h6 className="footer-title">Our address</h6>
                    <div>
                        <p className='text-accent'>New York 101010 hudson</p>
                    </div>
            ...
            <div className='footer-center p-4'>
                <p><small>Copyright © 2024 - All right reserved by SazeD Creation's</small></p>
            </div>
        </footer>
    );
};
